...
double Kp1, Ki1;
double gammap1 = 0.0425, gammai1 = 0.0425;
double alpha1, beta1;
double u11, u12;
...
double Kp2, Ki2;
double gammap2 = 0.0325, gammai2 = 0.0325;
double alpha2, beta2;
double u21, u22;
...
void TIM6_DAC_IRQHandler(void) {
    ...
    if (abs((int)(N1 - preN1)) < 40000)
        y13 = (N1 - preN1) * 60.0 * 100 / 7392;
    ...
    if (abs((int)(N2 - preN2)) < 40000)
        y23 = (N2 - preN2) * 60.0 * 100 / 7392;
    ...
    if (time_parameter == 500) {
        gammap1 = 0.0125, gammai1 = 0.0125;
        gammap2 = 0.0125, gammai2 = 0.0125;
    }

    if (time_parameter == 1000) {
        gammap1 = 0.0085, gammai1 = 0.0085;
        gammap2 = 0.0085, gammai2 = 0.0085;
    }

    if (time_parameter == 1500) {
        gammap1 = 0.00015, gammai1 = 0.00015;
        gammap2 = 0.00015, gammai2 = 0.00015;
    }
}
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart) {
    if (huart->Instance == huart2.Instance) {
        if (rx2_indx == 0)
            for (int i = 0; i < UART2_BUFF_SIZE; i++)
                rx2_buffer[i] = 0;

        if (rx2_data[0] != 'k')
            rx2_buffer[rx2_indx++] = rx2_data[0];
        else {
            if (((double)(rx2_buffer[1] - 48) + (double)(rx2_buffer[2] - 48) + (double)(rx2_buffer[4] - 48) +
                 (double)(rx2_buffer[5] - 48)) ==
                    ((double)(rx2_buffer[14] - 48) * 10 + (double)(rx2_buffer[15] - 48)) ||
                ((double)(rx2_buffer[8] - 48) + (double)(rx2_buffer[9] - 48) + (double)(rx2_buffer[11] - 48) +
                 (double)(rx2_buffer[12] - 48)) ==
                    ((double)(rx2_buffer[17] - 48) * 10 + (double)(rx2_buffer[18] - 48))) {
                set1 = (double)(rx2_buffer[1] - 48) * 10 + (double)(rx2_buffer[2] - 48) +
                       (double)(rx2_buffer[4] - 48) / 10 + (double)(rx2_buffer[5] - 48) / 100;
                set2 = (double)(rx2_buffer[8] - 48) * 10 + (double)(rx2_buffer[9] - 48) +
                       (double)(rx2_buffer[11] - 48) / 10 + (double)(rx2_buffer[12] - 48) / 100;
        ...
        tx2_data[14] = rx1_buffer[startIndx + 15];
        ...
        tx2_data[22] = rx1_buffer[startIndx + 36];
        tx2_data[23] = rx1_buffer[startIndx + 37];
        tx2_data[24] = rx1_buffer[startIndx + 38];
        tx2_data[25] = '.';
        tx2_data[26] = rx1_buffer[startIndx + 39];
        tx2_data[27] = rx1_buffer[startIndx + 40];
        tx2_data[28] = '\n';

        roll = (double)(rx1_buffer[2] - 48) * 100 + (double)(rx1_buffer[3] - 48) * 10 + (double)(rx1_buffer[4] - 48) +
               (double)(rx1_buffer[5] - 48) / 10 + (double)(rx1_buffer[6] - 48) / 100;
        if (rx1_buffer[1] == '-')
            roll = -roll;

        pitch = (double)(rx1_buffer[9] - 48) * 100 + (double)(rx1_buffer[10] - 48) * 10 +
                (double)(rx1_buffer[11] - 48) + (double)(rx1_buffer[12] - 48) / 10 +
                (double)(rx1_buffer[13] - 48) / 100;
        if (rx1_buffer[8] == '-')
            pitch = -pitch;

        yaw = (double)(rx1_buffer[16] - 48) * 100 + (double)(rx1_buffer[17] - 48) * 10 + (double)(rx1_buffer[18] - 48) +
              (double)(rx1_buffer[19] - 48) / 10 + (double)(rx1_buffer[20] - 48) / 100;
        if (rx1_buffer[15] == '-')
            yaw = -yaw;
